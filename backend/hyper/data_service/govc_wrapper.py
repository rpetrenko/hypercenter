from hyper.data_service.common import *
...
class HypervisorVcenter(object):
    ...
    def get_host(self, dc, host):
        """
        govc host.info -json -dc datacenter -host esxhost
        :param dc:
        :param host:
        :return:
        """
    ...
    def get_recent_tasks(self, limit=25):
        ...
        UnregisterVM             vm-clone-1*   Administrator  19:01:18  19:01:18  19:06:04   success [4m45.973085s]
        VirtualMachine.Destroy   vm-clone-1*   Administrator  18:51:03  18:51:03  19:06:04   error   [Operation timed out]
        :return:
        """
    ...
    def get_host_date(self, datacenter, host):
        """
        $ govc host.date.info -dc datacenter -host esxhost -json
